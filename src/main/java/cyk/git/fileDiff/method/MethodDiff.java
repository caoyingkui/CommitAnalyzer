...
import cyk.git.fileDiff.group.hash.update.UUpdate;
...
//
    ...
    public static int isSimilar(List<StatementHash> hashes1, List<StatementHash> hashes2) {
        ...
        return condition1 && condition2 && condition3 || condition4 || condition5 ? Math.max(max, similarSize) : - Math.max(max, similarSize);
